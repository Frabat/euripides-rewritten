...
export interface ApiAuthorAuthor extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'Historical authors';
    displayName: 'Author';
    pluralName: 'authors';
    singularName: 'author';
  };
...
export interface ApiCatalogCatalog extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    additionalDocuments: Schema.Attribute.Media<
      'files' | 'images' | 'videos',
      true
    >;
    authors: Schema.Attribute.Relation<'manyToMany', 'api::author.author'>;
...
export interface ApiCommentComment extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    endLine: Schema.Attribute.Integer;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::comment.comment'
    > &
      Schema.Attribute.Private;
    publishedAt: Schema.Attribute.DateTime;
    startLine: Schema.Attribute.Integer;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
  };
...
export interface ApiDocumentDocument extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    > &
      Schema.Attribute.Private;
    publishedAt: Schema.Attribute.DateTime;
    revisionHistory: Schema.Attribute.Component<'shared.revision-entry', true>;
    sectionRangeEnd: Schema.Attribute.String;
    sectionRangeStart: Schema.Attribute.String;
...
export interface ApiEditorEditor extends Struct.CollectionTypeSchema {
  collectionName: 'editors';
  info: {
    description: 'Modern scholars/editors';
    displayName: 'Editor';
    pluralName: 'editors';
    singularName: 'editor';
  };
  ...
  attributes: {
    ...
    publishedAt: Schema.Attribute.DateTime;
    role: Schema.Attribute.Enumeration<['Digital', 'Curator', 'Reviewer']>;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    user: Schema.Attribute.Relation<
...
export interface PluginUsersPermissionsUser
  ...
  attributes: {
    ...
    isScholar: Schema.Attribute.Boolean & Schema.Attribute.DefaultTo<false>;
    lastName: Schema.Attribute.String;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
