            ...
            <div className="bg-white p-8 rounded-lg shadow-sm border border-gray-200">
                <div className="mb-6">
                    ...
                    <h1 className="text-2xl font-serif font-bold flex items-center gap-2 mt-1">
                        <BookOpen className="w-6 h-6" /> Nuovo Libro / Edizione
                    </h1>
                </div>
                ...
                <form onSubmit={handleSubmit} className="space-y-6">
                    <div>
                        <label className="block text-sm font-medium text-gray-700 mb-1">Titolo Libro *</label>
                        <input
                            type="text"
                            required
                            value={title}
                            ...
                            placeholder="Es. Libro I, Tebaide di Stazio..."
                        />
                    </div>
                    ...
                    <div className="pt-4">
                        ...
                        >
                            {submitting ? "Creazione..." : <><Save className="w-5 h-5 inline mr-2" /> Crea Libro</>}
                        </button>
                    </div>
                </form>
            </div>
